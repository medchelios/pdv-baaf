...
class _PostpaidPaymentScreenState extends State<PostpaidPaymentScreen> {
  ...
  Future<void> _searchInvoices() async {
    if (_customerReferenceController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Veuillez entrer la référence client'),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: _isSearchingInvoices ? null : _searchInvoices,
                    icon: _isSearchingInvoices
                        ? const SizedBox(
                            width: 20,
                            height: 20,
